...
const state = computed(() => {
  ...
  const maps = { bill: [['未缴', 'warn'], ['已缴', 'success'], ['逾期', 'danger'], ['已作废', 'muted']], command: [['待下发', 'warn'], ['已发布', 'blue'], ['成功', 'success'], ['失败', 'danger'], ['超时', 'danger']], alarm: [['未处理', 'danger'], ['已处理', 'success']], online: [['离线', 'danger'], ['在线', 'success']], parse: [['失败', 'danger'], ['成功', 'success']] } as const
