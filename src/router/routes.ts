...
export const routeRecords: RouteRecordRaw[] = [
  ...
  { path: '/archive/orgs', redirect: '/device-archive/org-tree' }, page('/archive/spaces', 'archive-spaces', '空间台账', 'archive:list', 'resource', 'spaces'), page('/archive/gateways', 'archive-gateways', '网关管理', 'archive:list', 'resource', 'gateways'), { path: '/archive/devices', redirect: '/device-archive/devices' }, page('/archive/device-types', 'archive-device-types', '设备类型', 'archive:list', 'resource', 'device-types'), page('/archive/point-definitions', 'archive-point-definitions', '测点定义', 'archive:list', 'resource', 'point-definitions'),
  ...
  page('/alarms/events', 'alarms-events', '告警事件', 'alarm:rule:list', 'alarms'),
  { path: '/alarms/workbench', redirect: '/alarms/events' },
  { path: '/alarms/rules', redirect: '/alarms/protocols' },
  page('/alarms/protocols', 'alarms-protocols', '告警协议', 'alarm:rule:list', 'alarm-protocols'),
  ...
  page('/access/diagnostic', 'access-diagnostic', '接入诊断', 'access:view', 'access'), page('/access/edge-config', 'edge-config', '采集配置', 'archive:list', 'edge-config'), page('/access/control', 'access-control', '设备控制台', 'access:command', 'control'), { path: '/access/commands', redirect: (to) => ({ path: '/access/control', query: to.query }) },
